...
// Choosing Pivot by Deterministic Select Group of 3 (Calculating Median of Medians Recursively)
...
int main() {
	...
	ofstream my_file;
	my_file.open ("DSelect_3_Smallest_k.txt", ios::out | ios::app);
	my_file << "Array Size,DSelect_3 User_Time" << endl;
