...
// Choosing Pivot by Deterministic Select Group of 5 (Calculating Median of Medians Recursively)
...
int main() {
	...
	ofstream my_file;
	my_file.open ("DSelect_5_Smallest_k.txt", ios::out | ios::app);
	my_file << "Array Size,DSelect_5 User_Time" << endl;
